...
- `/insights`: Elo trend view plus splits, streaks, heatmap, and breakdowns, with a horizontally scrollable mobile chart that lets users tap a point to inspect it in a fixed card and open the game from an explicit CTA
